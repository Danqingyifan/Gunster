...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FOnHealthChanged, AActor*, Instigator, UCharacterAttributesComponent*, OwningComponent, float, NewHealth, float, Delta);

UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class GUNSTER_API UCharacterAttributesComponent : public UActorComponent
{
	GENERATED_BODY()
